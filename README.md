...
```
curl -LO https://open-vsx.org/api/omarkara/claude-status-chip/1.1.1/file/omarkara.claude-status-chip-1.1.1.vsix
code --install-extension omarkara.claude-status-chip-1.1.1.vsix
```
